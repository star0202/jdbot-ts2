...
export const CENSOR: {
  ...
  // https://github.com/KimuSoft/ypbot/blob/main/bot/src/officialRules.json
  {
    name: '씨발',
    regex:
      /([시쉬스슈싯싰씨씻씼쒸씺씹앂싸쓔취씌야ㅅへ人ㅆ⩘入八㉦㈆∧c]|\/\^|\/\/^ㅣ|ㅇㅑ|di|si|she|shi|shu|syu|shyu|ya|se|tl|\/\/^ㅣ)[ㄱ-ㅎㅏ-ㅣ0-9이으ㅣieㅡ-]*(빠|밠|밟|밣|밡|뿔|불|발|뱔|팔|펄|벌|뻘|빨|뿰|붤|봘|뷀|벨|벩|풜|밦|밟|밠|밢|㈅|㉥|ㅂ|8|ㅃ|var|bar|val|bal|vul|bul|bel|qkf)|[쉬쒸씨](바|ba)|[시씨띠][바파][아ㅏ]*[알랄]|^[시씨스ㅅㅆ][바ㅂ㈓]$|[씹쓉씝십쉽][할알팔발핧팛팙팘핤붤벨밸]|tlqk|ㅽ|18[놈넘]/g,
    ruleType: '욕설',
  },
  {
    name: '씨발 (초성 우회)',
  ...
  {
    name: '일간베스트',
    regex: /일베[충]?|일간[베배]스트|ㅇㅂㅊ|^ㅇㅂ[ㅅㄲㅊㄱ]+$|^일배$|^ㅇㅂ$/g,
    ruleType: '정치적 발언',
  },
  {
    name: '메갈리아',
